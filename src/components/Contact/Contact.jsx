        ...
        <section className="contact-section" id="contact" aria-label="Contact Elixor Technologies">
            ...
            <div className="contact-container">
                ...
                >
                    ...
                    <address className="contact-direct-details" aria-label="Direct contact details">
                        <a href="tel:+919358101310" aria-label="Call Elixor Technologies at 9358101310">
                            <span className="contact-direct-icon"><Phone size={18} /></span>
                            <span><small>Call us</small>9358101310</span>
                        </a>
                        <a href="mailto:contact@elixortech.com" aria-label="Email Elixor Technologies at contact@elixortech.com">
                            <span className="contact-direct-icon"><Mail size={18} /></span>
                            <span><small>Email us</small>contact@elixortech.com</span>
                        </a>
                    </address>
